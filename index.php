...
<body>
  ...
  <div class="px-4 py-5 my-5 text-center" id="logoOur">
    ...
    <div class="col-lg-6 mx-auto">
      <p class="lead mb-4">
        Tenun is an artful Indonesian technique of making a fabric by weaving different colours of threads. Tenun
        belongs to one of the typical Indonesian cultural arts produced by hand skills using traditional looms.
      </p>
    </div>
  </div>
        ...
        <div class="g-col-6 g-col-md-3">
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Tenun ikat atau kain ikat adalah kriya tenun Indonesia berupa kain yang ditenun dari
                helaian benang pakan atau benang lungsin yang sebelumnya diikat dan dicelupkan ke dalam zat pewarna
                alami.</p>
        ...
        <div class="g-col-6 g-col-md-3">
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                Songket digolongkan dalam keluarga tenunan brokat. Songket ditenun dengan tangan menggunakan benang emas
                dan perak. Benang logam metalik yang tertenun berlatar kain menimbulkan efek kemilau cemerlang.
              </p>
              <a href="#" class="btn btn-primary">See More</a>
            </div>
          </div>
        ...
        <div class="g-col-6 g-col-md-3">
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                Kata gringsing terdiri dari kata gring yang berarti 'sakit' dan sing yang berarti 'tidak' sehingga dapat
                dimaknai bahwa kain gringsing merupakan kain magis yang membuat pemakainya terhindar dari bala.
              </p>
              <a href="#" class="btn btn-primary">See More</a>
            </div>
          </div>
        ...
        <div class="g-col-6 g-col-md-3">
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Umumnya Tenun Sidemen memiliki banyak jenis, seperti contohnya tenun endek dan
                songket yang memiliki ciri khas tersendiri.</p>
              <a href="#" class="btn btn-primary">See More</a>
            </div>
          </div>
        </div>
        <div class="g-col-6 g-col-md-3">
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Endek adalah kain tenun yang berasal dari Bali. Kain endek merupakan hasil dari karya
                seni rupa terapan, yang berarti karya seni yang dapat diterapkan dalam kehidupan sehari-hari.</p>
              <a href="#" class="btn btn-primary">See More</a>
            </div>
          </div>
        </div>
        <div class="g-col-6 g-col-md-3">
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                Tenun Rangrang merupakan kain bebali yang berasal dari Seraya Timur dan Nusa Penida dengan motif
                geometris zigzag, belah ketupat, dan lajur œ lajur vertikal dengan warna-warni yang terang dengan
                inspirasi motif berasal
